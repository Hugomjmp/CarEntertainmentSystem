...
void ConsoleUI::showMainMenu() const{
    ...
    std::cout << "| 4 - set volume         |" << std::endl;
    std::cout << "| 5 - pause music        |" << std::endl;
    std::cout << "| 6 - stop music         |" << std::endl;
    std::cout << "| 7 - Get Song Time      |" << std::endl;
    std::cout << "| 8 - library Settings   |" << std::endl;
    std::cout << "| 9 - Loop Current Song  |" << std::endl;
    std::cout << "| 10 - Playlist Settings |" << std::endl;
    std::cout << "| 11 - Play Playlist     |" << std::endl;
    std::cout << "| 12 - Set Loop Playlist |" << std::endl;
    std::cout << "| 13 - Next Song         |" << std::endl;
    std::cout << "| 14 - Previous Song     |" << std::endl;
    std::cout << "| 15 - exit program      |" << std::endl;
    std::cout << "+------------------------+" << std::endl;
    std::cout << "#> ";
}
